...
напишите функции которые с помощью функциональных методов массивов (никаких for, splice и т. д.) выполняют следующие операции.
*/
...
const getInactiveUsers = users => {
  ...
  users.filter(user => {
    if (!user.isActive) {
      dontUserActive.push(user);
    }
  });
  return dontUserActive;
};
